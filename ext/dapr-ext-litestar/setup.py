...
version_info = {}
with open('dapr/ext/litestar/version.py') as fp:
...
name = 'dapr-ext-litestar'
version = __version__
description = 'The official release of Dapr Litestar extension.'
long_description = '''
This is the Litestar extension for Dapr.
...
if not is_release():
    ...
    description = 'The developmental release for Dapr Litestar extension.'
    long_description = 'This is the developmental release for Dapr Litestar extension.'
